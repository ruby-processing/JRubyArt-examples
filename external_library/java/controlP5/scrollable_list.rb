...
java_import 'controlP5.ScrollableList'
...
#   puts("#{n}, #{cp5.get(ScrollableList.class, 'dropdown').getItem(n)}")
...
#     list = %w[a-1 b-1 c-1 d-1 e-1 f-1 g-1 h-1 i-1 j-1 k-1]
#     cp5.get(ScrollableList.class, "dropdown").setItems(list)
#
#   when '4'
