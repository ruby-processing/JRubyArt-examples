...
java_import 'com.thomasdiewald.pixelflow.java.flowfieldparticles.DwFlowFieldParticles'
...
def setup
  ...
  particles.createObstacleFlowField(pg_obstacles, [0, 0, 0, 255], false)
...
def draw
  ...
  txt_fps = format(format_string, frame_rate, particles.getCount )
